<template>
  ...
  import RaumAnzeigen from './Raumverwaltung/RaumAnzeigen.vue';
  import RaumVerwalten from './Raumverwaltung/RaumVerwalten.vue';
  import RaumAnlegen from './Raumverwaltung/RaumAnlegen.vue';
  
  export default defineComponent({
    name: 'VerwaltungPage',
    // eslint-disable-next-line vue/no-unused-components
    components: { IonHeader, IonToolbar, IonTitle, IonContent, IonPage, IonCol, IonRow, IonList, RaumAnzeigen, RaumVerwalten, RaumAnlegen }
  });
  </script>
