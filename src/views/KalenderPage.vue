<template>
    <ion-page>
      ...
      <ion-content :fullscreen="true">
        ...
        <ion-datetime size="cover" id="calendar_1"></ion-datetime>

        <!---Hier beginnt der FullCalendar:-->


        <!--Hier beginnt der vCalendar-->
        <!------
  ...
  export default ({
    name: 'KalenderPage',
    components: { IonHeader, IonToolbar, IonTitle, IonContent, IonPage, IonDatetime },
    data() {
